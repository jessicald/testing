...
__desc__ = 'This program outputs a Python 2 string of random bytes useful for cryptographic hash salts.'
...
try:
    ...
    stderr.write('error: please enter a base 10 integer e.g. 2048\n\n%s\nusage: %s INTEGER\n' % (__desc__, argv[0]))
    exit(2)
